...
DATASET2=workspace/examples/bert/data/hdf5_lower_case_1_seq_len_128_max_pred_20_masked_lm_prob_0.15_random_seed_12345_dupe_factor_5/wikicorpus_en # change this for other datasets
DATA_DIR_PHASE2=${22:-$BERT_PREP_WORKING_DIR/${DATASET2}/}
CODEDIR=${23:-"/workspace/examples/bert"}
...
CMD="python3 -m torch.distributed.launch --nnodes 2 --nproc_per_node=$num_gpus $CMD"
