...
class BertSelfAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask):
        ...
        attention_probs = F.softmax(attention_scores, dim=-1, dtype=attention_scores.dtype)
...
class BertForQuestionAnswering(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask):
        ...
        single_output = sequence_output[0] #sequence output always has to be list for jit purposes
        logits = self.qa_outputs(single_output)
