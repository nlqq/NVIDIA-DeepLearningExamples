...
{
  return (GET_CODE (op) == REG) ? ((
#line 43 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 59 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 64 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == REG) && (
#line 69 "../../gcc/config/i386/predicates.md"
(MASK_REGNO_P (REGNO (op))))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}

static inline int
q_regs_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
...
int
q_regs_operand (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
{
...
{
  return ((GET_CODE (op) == REG) && (
#line 120 "../../gcc/config/i386/predicates.md"
(REGNO (op) == FLAGS_REG))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
(TARGET_64BIT)) && (
#line 131 "../../gcc/config/i386/predicates.md"
(REGNO (op) > BX_REG)))) && (
(mode == VOIDmode || GET_MODE (op) == mode));
}
...
#line 140 "../../gcc/config/i386/predicates.md"
{
  if (!TARGET_64BIT)
...
#line 266 "../../gcc/config/i386/predicates.md"
{
  switch (GET_CODE (op))
    {
    case CONST_DOUBLE:
...
{
  return (
#line 368 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 375 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 391 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 406 "../../gcc/config/i386/predicates.md"
...
#line 416 "../../gcc/config/i386/predicates.md"
{
  if (!flag_pic)
    return false;
...
#line 559 "../../gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
#line 573 "../../gcc/config/i386/predicates.md"
{
  if (GET_CODE (op) == SUBREG)
    op = SUBREG_REG (op);
...
{
  return (
#line 616 "../../gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((call_register_no_elim_operand (op, mode)) || ((!(
#line 619 "../../gcc/config/i386/predicates.md"
(TARGET_X32))) && (memory_operand (op, mode))));
}
...
{
  return (
#line 624 "../../gcc/config/i386/predicates.md"
(constant_call_address_operand
		     (op, mode == VOIDmode ? mode : Pmode))) || ((register_no_elim_operand (op, mode)) || ((!(
#line 627 "../../gcc/config/i386/predicates.md"
...
#line 676 "../../gcc/config/i386/predicates.md"
{
...
#line 692 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
...
#line 716 "../../gcc/config/i386/predicates.md"
{
  HOST_WIDE_INT i = INTVAL (op);
  return i == 4 || i == 8;
}
...
(op == const0_rtx)) || (
#line 725 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)));
}
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 740 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 745 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 755 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 779 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 790 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 830 "../../gcc/config/i386/predicates.md"
...
{
  return (GET_CODE (op) == CONST_INT) && (
#line 835 "../../gcc/config/i386/predicates.md"
...
#line 882 "../../gcc/config/i386/predicates.md"
(op == const1_rtx)) || (
...
{
  return (
#line 887 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 892 "../../gcc/config/i386/predicates.md"
...
#line 900 "../../gcc/config/i386/predicates.md"
{
  unsigned n_elts;
...
static inline int
vector_all_ones_operand_1 (rtx op, machine_mode mode ATTRIBUTE_UNUSED)
...
#line 976 "../../gcc/config/i386/predicates.md"
{
...
#line 1035 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1067 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
{
  return ((
#line 1066 "../../gcc/config/i386/predicates.md"
(address_operand (op, VOIDmode))) && (
...
#line 1164 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1176 "../../gcc/config/i386/predicates.md"
{
  struct ix86_address parts;
  int ok;
...
#line 1201 "../../gcc/config/i386/predicates.md"
{
...
#line 1233 "../../gcc/config/i386/predicates.md"
...
{
  return (
#line 1311 "../../gcc/config/i386/predicates.md"
...
#line 1319 "../../gcc/config/i386/predicates.md"
{
  enum rtx_code code = GET_CODE (op);
  bool ret;
...
#line 1369 "../../gcc/config/i386/predicates.md"
...
{
  return ((GET_CODE (op) == MEM) && (
#line 1380 "../../gcc/config/i386/predicates.md"
...
#line 1385 "../../gcc/config/i386/predicates.md"
{
  unsigned i;
...
#line 1438 "../../gcc/config/i386/predicates.md"
...
#line 1445 "../../gcc/config/i386/predicates.md"
{
...
#line 1461 "../../gcc/config/i386/predicates.md"
{
...
#line 1476 "../../gcc/config/i386/predicates.md"
{
...
insn_const_int_ok_for_constraint (HOST_WIDE_INT ival, enum constraint_num c)
{
  switch (c)
    ...
    case CONSTRAINT_I:
      return 
#line 180 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 31));

    case CONSTRAINT_J:
      return 
#line 185 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 63));

    case CONSTRAINT_K:
      return 
#line 190 "../../gcc/config/i386/constraints.md"
...
(ival == 0xff || ival == 0xffff
    ...
    case CONSTRAINT_M:
      return 
#line 202 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 3));
...
(IN_RANGE (ival, 0, 255));
    ...
    case CONSTRAINT_O:
      return 
#line 213 "../../gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 127));
