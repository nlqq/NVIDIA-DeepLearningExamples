...
satisfies_constraint_Bs (rtx op)
{
  ...
  return (!(
#line 160 "../../gcc/config/i386/constraints.md"
...
satisfies_constraint_Bw (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (!(
#line 165 "../../gcc/config/i386/constraints.md"
...
{
  return 
#line 174 "../../gcc/config/i386/constraints.md"
...
#line 222 "../../gcc/config/i386/constraints.md"
...
satisfies_constraint_We (rtx op)
{
  machine_mode mode = GET_MODE (op);
  return (x86_64_immediate_operand (op, mode)) && (
#line 245 "../../gcc/config/i386/constraints.md"
...
#line 252 "../../gcc/config/i386/constraints.md"
(GET_MODE (op) != VOIDmode));
}
static inline bool
