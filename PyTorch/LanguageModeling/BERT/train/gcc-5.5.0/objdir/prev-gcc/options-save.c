                     ...
                     struct cl_target_option const *ptr2 ATTRIBUTE_UNUSED)
{
  ...
  if (ptr1->x_ix86_isa_flags_explicit != ptr2->x_ix86_isa_flags_explicit)
    return false;
  if (ptr1->x_ix86_target_flags_explicit != ptr2->x_ix86_target_flags_explicit)
    return false;
...
cl_target_option_hash (struct cl_target_option const *ptr ATTRIBUTE_UNUSED)
{
  ...
  if (ptr->x_ix86_tune_string)
    ...
    hstate.add_int (0);
  hstate.add_wide_int (ptr->x_ix86_isa_flags_explicit);
  hstate.add_wide_int (ptr->x_ix86_target_flags_explicit);
  hstate.add_wide_int (ptr->x_ix86_asm_dialect);
  hstate.add_wide_int (ptr->x_ix86_abi);
  hstate.add_wide_int (ptr->x_ix86_cmodel);
  hstate.add_wide_int (ptr->x_ix86_veclibabi_type);
  hstate.add_wide_int (ptr->x_ix86_pmode);
  hstate.add_wide_int (ptr->x_ix86_stack_protector_guard);
  hstate.add_wide_int (ptr->x_ix86_stringop_alg);
  hstate.add_wide_int (ptr->x_ix86_tls_dialect);
  hstate.add_wide_int (ptr->x_ix86_branch_cost);
  hstate.add_wide_int (ptr->x_ix86_dump_tunes);
  hstate.add_wide_int (ptr->x_ix86_force_align_arg_pointer);
  hstate.add_wide_int (ptr->x_ix86_force_drap);
  hstate.add_wide_int (ptr->x_ix86_incoming_stack_boundary_arg);
  hstate.add_wide_int (ptr->x_ix86_preferred_stack_boundary_arg);
  hstate.add_wide_int (ptr->x_ix86_regparm);
  hstate.add_wide_int (ptr->x_ix86_section_threshold);
  hstate.add_wide_int (ptr->x_ix86_sse2avx);
  hstate.add_wide_int (ptr->x_ix86_tune_no_default);
  hstate.add_wide_int (ptr->x_recip_mask_explicit);
  hstate.add_wide_int (ptr->arch);
  hstate.add_wide_int (ptr->arch_specified);
  hstate.add_wide_int (ptr->branch_cost);
  hstate.add_wide_int (ptr->prefetch_sse);
  hstate.add_wide_int (ptr->schedule);
  hstate.add_wide_int (ptr->tune);
  hstate.add_wide_int (ptr->tune_defaulted);
  hstate.add_wide_int (ptr->x_recip_mask);
  hstate.add_wide_int (ptr->x_target_flags);
  hstate.add_wide_int (ptr->x_ix86_isa_flags);
                             ...
                             struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ...
  bp_pack_value (bp, ptr->x_ix86_target_flags_explicit, 64);
                            ...
                            struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ...
  ptr->x_ix86_target_flags_explicit = (HOST_WIDE_INT) bp_unpack_value (bp, 64);
